...
#ifndef SFML_MYFONT_HPP
#define SFML_MYFONT_HPP
...
///
////////////////////////////////////////////////////////////
class SFML_GRAPHICS_API MyFont
{
public:
...
public:
    ...
    /// the sf::MyFont object loads a new font or is destroyed.
    ///
    ...
    /// valid until the sf::MyFont object loads a new font or
    /// is destroyed.
    ///
    ...
    ///
    ////////////////////////////////////////////////////////////
    MyFont& operator =(const MyFont& right);
...
private:
    ...
    // Types
    ////////////////////////////////////////////////////////////
    typedef std::map<Uint32, MyGlyph> GlyphTable; ///< Table mapping a codepoint to its glyph
    ...
    ///
    ////////////////////////////////////////////////////////////
    MyGlyph loadGlyph(Uint32 codePoint, unsigned int characterSize, bool bold) const;
...
///
/// Once it is loaded, a sf::MyFont instance provides three
...
/// use the sf::MyText class, which is able to properly output text
/// with several options such as character size, style, color,
/// position, rotation, etc.
/// This separation allows more flexibility and better performances:
/// indeed a sf::MyFont is a heavy resource, and any operation on it
/// is slow (often too slow for real-time applications). On the other
/// side, a sf::MyText is a lightweight object which can combine the
/// glyphs data and metrics of a sf::MyFont to display any text on a
/// render target.
/// Note that it is also possible to bind several sf::MyText instances
/// to the same sf::MyFont.
///
...
/// text1.setStyle(sf::MyText::Regular);
///
/// // Create another text using the same font, but with different parameters
/// sf::MyText text2;
/// text2.setFont(font);
/// text2.setCharacterSize(50);
/// text2.setStyle(sf::MyText::Italic);
/// \endcode
///
/// Apart from loading font files, and passing them to instances
/// of sf::MyText, you should normally not have to deal directly
/// with this class. However, it may be useful to access the
/// font metrics or rasterized glyphs for advanced usage.
///
/// Note that if the font is a bitmap font, it is not scalable,
/// thus not all requested sizes will be available to use. This
/// needs to be taken into consideration when using sf::MyText.
